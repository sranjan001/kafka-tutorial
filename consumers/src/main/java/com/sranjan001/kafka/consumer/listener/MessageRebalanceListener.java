package com.sranjan001.kafka.consumer.listener;
...
public class MessageRebalanceListener implements ConsumerRebalanceListener {
    private final static Logger logger = LoggerFactory.getLogger(MessageRebalanceListener.class);
    ...
    public void onPartitionsRevoked(Collection<TopicPartition> partitions) {
        logger.info("onPartitionRevoked: {}", partitions);
