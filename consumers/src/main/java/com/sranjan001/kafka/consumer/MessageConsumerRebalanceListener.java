...
public class MessageConsumerRebalanceListener {
    ...
    private final static Logger logger = LoggerFactory.getLogger(MessageConsumerRebalanceListener.class);
...
//        propsMap.put(ConsumerConfig.AUTO_COMMIT_INTERVAL_MS_CONFIG, "10000");
    ...
    public void pollKafka() {
        kafkaConsumer.subscribe(List.of(topic), new MessageRebalanceListener(kafkaConsumer));
